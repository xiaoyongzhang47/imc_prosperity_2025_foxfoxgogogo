...
PARAMS = {
    ...
    Product.KELP: {
        ...
        "adverse_volume": 15,
        "reversion_beta": random.uniform(-0.2,0.2),
        "disregard_edge": 1,
        "join_edge": 0,
        "default_edge": 1,
    },
        ...
        "prevent_adverse": True,
        "adverse_volume": 15,
        "reversion_beta": random.uniform(-0.2,0.1),
        "disregard_edge": 1,
        "join_edge": 0,
        "default_edge": 1,
    },
...
class Trader:
    def __init__(self, params=None):
        ...
        self.LIMIT = {Product.RAINFORESTRESIN: 50, Product.KELP: 50, Product.SQUIDINK:25}
    ...
    def run(self, state: TradingState):
        ...
        if self.params[Product.SQUIDINK]["do_trade"] and Product.SQUIDINK in self.params and Product.SQUIDINK in state.order_depths:
                SQUIDINK_position = (
