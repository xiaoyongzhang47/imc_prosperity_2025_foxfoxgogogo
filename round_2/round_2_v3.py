    ...
    def run(self, state: TradingState):
        ...
        if every_thing_is_good:
            ...
            if picnicbask1_is_good:
                ...
                if solo_trade_pb1:
                    PICNICBASK1_take_orders, buy_order_volume, sell_order_volume = (
                        self.take_orders(
                            Product.PICNICBASKET1,
                            state.order_depths[Product.PICNICBASKET1],
                            PICNICBASKET1_fair_value,
                            self.params[Product.PICNICBASKET1]["take_width"],
                            PICNICBASK1_position,
                            self.params[Product.PICNICBASKET1]["prevent_adverse"],
                            self.params[Product.PICNICBASKET1]["adverse_volume"],
                        )
                    )
                    PICNICBASK1_clear_orders, buy_order_volume, sell_order_volume = (
                        self.clear_orders(
                            Product.PICNICBASKET1,
                            state.order_depths[Product.PICNICBASKET1],
                            PICNICBASKET1_fair_value,
                            self.params[Product.PICNICBASKET1]["clear_width"],
                            PICNICBASK1_position,
                            buy_order_volume,
                            sell_order_volume,
                        )
                    )
                    PICNICBASK1_make_orders, _, _ = self.make_orders(
                        Product.PICNICBASKET1,
                        state.order_depths[Product.PICNICBASKET1],
                        PICNICBASKET1_fair_value,
                        PICNICBASK1_position,
                        buy_order_volume,
                        sell_order_volume,
                        self.params[Product.PICNICBASKET1]["disregard_edge"],
                        self.params[Product.PICNICBASKET1]["join_edge"],
                        self.params[Product.PICNICBASKET1]["default_edge"],
                    )

                    picnicbask1_solo_trading =  (
                        PICNICBASK1_take_orders + PICNICBASK1_clear_orders + PICNICBASK1_make_orders
                    )
                ...
                if zscore > entry_threshold:
                    ...
                    CROISSANTS_buy_order_volume  = 6 * PICNICBASKET1_sell_order_volume
                    JAMS_buy_order_volume        = 3 * PICNICBASKET1_sell_order_volume
                    DJEMBES_buy_order_volume     = 1 * PICNICBASKET1_sell_order_volume
                    ...
                    if random.uniform(0, 1) < prod_strength:
                        CROISSANTS_pt_orders, CROISSANTS_buy_order_volume, CROISSANTS_sell_order_volume = (
                            self.pair_trading_orders(
                                ...
                                target_volume=CROISSANTS_buy_order_volume,
                        ...
                        JAMS_pt_orders, JAMS_buy_order_volume, JAMS_sell_order_volume = (
                            self.pair_trading_orders(
                                ...
                                target_volume=JAMS_buy_order_volume,
                        ...
                        DJEMBES_pt_orders, DJEMBES_buy_order_volume, DJEMBES_sell_order_volume = (
                            self.pair_trading_orders(
                                ...
                                target_volume=DJEMBES_buy_order_volume,
                    ...
                    CROISSANTS_sell_order_volume = 6 * PICNICBASKET1_buy_order_volume
                    JAMS_sell_order_volume       = 3 * PICNICBASKET1_buy_order_volume
                    DJEMBES_sell_order_volume     = 1 * PICNICBASKET1_buy_order_volume
                    ...
                    if random.uniform(0, 1) < prod_strength:
                        CROISSANTS_pt_orders, CROISSANTS_buy_order_volume, CROISSANTS_sell_order_volume = (
                            self.pair_trading_orders(
                                order_type='sell',
                                product=Product.CROISSANTS,
                                target_volume=CROISSANTS_sell_order_volume,
                                order_depth=state.order_depths[Product.CROISSANTS],
                                fair_value=CROISSANTS_fair_value,
                                width = buy_width,
                                position =CROISSANTS_position,
                        ...
                        JAMS_pt_orders, JAMS_buy_order_volume, JAMS_sell_order_volume = (
                            self.pair_trading_orders(
                                order_type='sell',
                                product=Product.JAMS,
                                target_volume=JAMS_sell_order_volume,
                                order_depth=state.order_depths[Product.JAMS],
                                fair_value=JAMS_fair_value,
                                width = buy_width,
                                position =JAMS_position,
                        ...
                        DJEMBES_pt_orders, DJEMBES_buy_order_volume, DJEMBES_sell_order_volume = (
                            self.pair_trading_orders(
                                order_type='sell',
                                product=Product.DJEMBES,
                                target_volume=DJEMBES_sell_order_volume,
                                order_depth=state.order_depths[Product.DJEMBES],
                                fair_value=DJEMBES_fair_value,
                                width = buy_width,
                                position =DJEMBES_position,
            ...
            if picnicbask2_is_good and False:
                # do pair trading with basket 1
                # get position
                ...
                if zscore > entry_threshold:
                    ...
                    if random.uniform(0, 1) < buy_strength:
                    ...
                    CROISSANTS_buy_order_volume = 4 * PICNICBASKET2_sell_order_volume
                    JAMS_buy_order_volume       = 2 * PICNICBASKET2_sell_order_volume
                    

                    if random.uniform(0, 1) < sell_strength:
                        CROISSANTS_pt_orders, CROISSANTS_buy_order_volume, CROISSANTS_sell_order_volume = (
                            self.pair_trading_orders(
                                order_type='buy',
                                product=Product.CROISSANTS,
                    ...
                    CROISSANTS_sell_order_volume = 4 * PICNICBASKET2_buy_order_volume
                    JAMS_sell_order_volume       = 2 * PICNICBASKET2_buy_order_volume
